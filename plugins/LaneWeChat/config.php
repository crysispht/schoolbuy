 ...
 */
define("WECHAT_URL", 'https://crysispht.ngrok.cc/schoolbuy(openshift)/plugins/LaneWeChat/wechat.php');
define('WECHAT_TOKEN', 'crysispht');
define('ENCODING_AES_KEY', "wEdjOhwfcI3WzCmEi18QaPewQmr9KoNJCqxLyG0leQ4");

/*
 * 开发者配置
 */
define("WECHAT_APPID", 'wx5c835f09d7b88cbc');
